...
if uploaded_file:
    ...
    if filtered_data.empty:
        ...
        ax.set_title(f"{selected_company} 연도별 매출", fontproperties=font_prop)
        ...
        ax.set_xlabel('연도', fontproperties=font_prop)
        ax.set_ylabel('순위', fontproperties=font_prop)
        ax.set_title(f"{selected_company} 연도별 순위 변화", fontproperties=font_prop)
