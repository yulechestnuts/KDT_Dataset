...
export const CATEGORY_GROUPS: Record<string, CourseCategory[]> = {
  ...
  '콘텐츠·게임': ['게임', 'XR/실감콘텐츠', '영상/미디어제작'],
  '하드웨어·제조': ['반도체', '임베디드/IoT', '로봇/자율주행', '스마트제조/디지털트윈', '건설/공간', '이차전지/에너지', '바이오/헬스', '환경/탄소중립'],
...
export const MANUAL_OVERRIDES: Array<[string, CourseCategory]> = [
  ...
  ['정림] 아카데미', '건설/공간'], // 정림 = 건축설계사무소
  // 한화오션 — 교과편성 실측(2026-09-08): 구조설계 284h · 종합실무프로젝트 318h ·
  // OCEANQM/NDT 112h. AI 머신러닝은 '현장적용 신기술사례' 72h(8%) 뿐이라 AI 과정이 아니다.
  ['Ocean DX Academy', '스마트제조/디지털트윈'], // 한화오션 (조선 설계·품질)
  ['현대건설]', '건설/공간'], // Smart City / Smart Plant / Smart 안전
  // 교과편성 실측(2026-09-08): 시네마4D·언리얼 그래픽·리얼리티캡쳐 324h+320h.
  // 'AI Media Craft' 라는 이름에는 영상 신호가 없어 규칙으로 못 잡는다.
  ['AI Media Craft', '영상/미디어제작'], // 엠비씨플러스 — 시네마틱 3D
  // 이름에 '게임'·'블렌더'가 있어 게임/영상으로 새지만 교과는 VR 실감콘텐츠다.
  ['3D 게임그래픽 디자이너', 'XR/실감콘텐츠'],   // 인하대 — VR 모델링 232h·테마파크 프로젝트 680h
  ['게임 그래픽 디자이너 양성(영상', 'XR/실감콘텐츠'], // MBC 신림 — VR FPS·해군 선박 실감형
  ['블렌더활용 VR 실감형콘텐츠', 'XR/실감콘텐츠'],  // 윤성 — 공장/병원 비상대피 VR 150h
];
...
export const KEYWORD_RULES: KeywordRule[] = [
  ...
  // 건설·건축·공간. 스마트제조(90)·게임(90)을 이긴다 —
  // '메타버스 건축 모델링'처럼 이름에 VR 이 붙어 게임으로 새던 것을 잡는다.
  { category: '건설/공간', pattern: /\bBIM\b|프리콘|건설|건축|시공|토목|플랜트|인테리어|실내\s*건축|도시\s*계획|스마트\s*시티|smart\s*city|버티포트|적산|revit|레빗|조경/i, priority: 91 },
  ...
  // 영상 제작은 게임(90)·XR(88)을 이긴다 — 언리얼이 영상 제작 도구로도 쓰이기 때문이다.
  // 맨 '그래픽' 은 일부러 넣지 않았다: `3D 게임그래픽 디자이너` 를 게임에서 뺏어 온다.
  { category: '영상/미디어제작', pattern: /시네마틱|시네메틱|미디어\s*아트|미디어아트|영상\s*(제작|편집|콘텐츠|크리에이터)|모션\s*그래픽|모션그래픽|\bVFX\b|웹툰|애니메이션|프리미어|애프터\s*이펙트|에펙|블렌더|blender|시네마\s*4D|cinema\s*4d|미디어\s*콘텐츠|콘텐츠\s*크리에이터|버추얼\s*프로덕션|영화|비디오북/i, priority: 92 },
